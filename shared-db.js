...
(function () {
  ...
  function _normalizeLeaveRecord(record) {
    ...
    return {
      ...
      reconciliationSourceId: String(record.reconciliationSourceId || '').trim(),
      ...
      makeupMode: String(record.makeupMode || '').trim(),
      paperRequiredAt: _toIsoString(record.paperRequiredAt, ''),
      parentSignedAt: _toIsoString(record.parentSignedAt, ''),
